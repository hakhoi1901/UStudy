...
export const GROUP_PREFERENCES_GUIDE: UserGuide = {
  ...
  steps: [
    ...
    { id: 'prefs-sharing-modes', route: '/study-roadmap/calendar', target: '[data-guide="group-course-sharing-modes"]', title: 'Chiến lược học chung', content: 'Mặc định thuật toán có thể xếp mọi người vào các lớp ngẫu nhiên (Ai cũng được). Nếu chọn "Bắt buộc cùng lớp", thuật toán ép toàn bộ thành viên đang đăng ký môn này phải vào chung 1 lớp!', beforeAction: 'expand-course-sharing', placement: 'top' },
    { id: 'prefs-sharing-split', route: '/study-roadmap/calendar', target: '[data-guide="group-course-sharing-split"]', title: 'Tách nhóm nhỏ', content: 'Nhưng nếu nhóm có 4 người, bạn muốn 2 người học lớp này, 2 người học lớp kia thì sao? Hãy chọn chế độ "Chia nhóm"!', beforeAction: 'expand-course-sharing', placement: 'bottom' },
