            ...
            <div className="flex w-full items-center gap-2 md:w-auto">
                ...
                <div className="hidden md:block">
                    ...
                    >
                        ...
                        <PopoverContent align="end" sideOffset={8} collisionPadding={16} className="flex max-h-[min(720px,calc(100dvh-2rem))] w-[min(440px,calc(100vw-2rem))] flex-col overflow-hidden rounded-xl border border-gray-200 !bg-white !text-gray-900 p-0 shadow-[0_18px_45px_rgba(15,23,42,0.16)]">
