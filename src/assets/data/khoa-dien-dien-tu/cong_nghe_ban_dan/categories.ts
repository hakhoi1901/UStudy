...
export const categories = {
  "GENERAL_EDUCATION": {
    ...
    "breakdown": {
      ...
      "GENERAL_SOCIAL": {
        ...
        "credits": 2,
        "mandatory": false,
        "note": "Chọn 1 học phần (02 tín chỉ)",
        "courses": [
          "BAA00005",
          "BAA00006",
          "BAA00007"
      ...
      "GENERAL_MATH_SCIENCE": {
        ...
        "credits": 35,
        "mandatory": true,
        "note": "Bắt buộc 33 TC + Tự chọn Môi trường/Khoa học trái đất 2 TC (chọn 1)",
        "breakdown": {
          "MANDATORY": {
            "name": "Bắt buộc",
            "credits_required": 33,
  ...
  "MAJOR": {
    ...
    "breakdown": {
      "MAJOR_SEMICONDUCTOR": {
        "name": "Chuyên ngành Công nghệ bán dẫn",
        "total_credits_required": 37,
        "breakdown": {
          "ELECTIVE": {
            "name": "Tự chọn chuyên ngành",
            "credits": 37,
            "note": "Tích lũy tổng cộng 37 tín chỉ từ các học phần",
            "courses": [
              "SEM10101",
              "SEM10102",
              "SEM10103",
  ...
  "GRADUATION": {
    ...
    "options": [
      ...
      },
      {
        ...
        "credits": 10,
        "note": "Đồ án tốt nghiệp (6TC) kết hợp chọn tối thiểu 4 tín chỉ trong Khối kiến thức chuyên ngành",
        "courses": [
          "SEM10991"
        ]
      }
