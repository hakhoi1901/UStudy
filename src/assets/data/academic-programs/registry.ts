...
export const ACADEMIC_YEAR_MAJOR_CATALOGS: AcademicYearMajorCatalog[] = [
    {
        ...
        faculties: [
            ...
            },
            {
                ...
                name: 'Khoa Vật lý - Vật lý Kỹ thuật',
                majors: [
                    { id: 'vat-ly-hoc', name: 'Vật lý học', dataSourceCohort: 'k25' },
                    { id: 'cu-nhan-tai-nang-vat-ly-hoc', name: 'cử nhân tài năng vật lý học', dataSourceCohort: 'k25'},
                    { id: 'vat-ly-y-khoa', name: 'Vật lý y khoa', dataSourceCohort: 'k25' },
                    { id: 'hai-duong-hoc', name: 'Hải dương học', dataSourceCohort: 'k25' },
                    { id: 'ky-thuat-hat-nhan', name: 'Kỹ thuật hạt nhân', dataSourceCohort: 'k25' },
                    { id: 'cong-nghe-vat-ly-dien-tu-va-tin-hoc', name: 'CN Vật lý điện tử và tin học', dataSourceCohort: 'k25' },
                    { id: 'cong-nghe-ban-dan', name: 'CN Bán dẫn', dataSourceCohort: 'k25' },
                ],
            },
            {
                id: 'khoa-hoa',
